...
class HappinessChallenges extends StatefulWidget {
  HappinessChallenges({Key? key}) : super(key: key);

  @override
  _SelfLoveChallengesState createState() => _SelfLoveChallengesState();
}

class _SelfLoveChallengesState extends State<HappinessChallenges> {
