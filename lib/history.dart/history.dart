...
//                                   }
//                                 },
//                                 child: Consumer<MyButtonClickedProvider>(
//                                   builder: (context, buttonProvider, _) {
//                                     final int? selectedDayIndex = buttonProvider
//                                         .getSelectedDayIndex(widget.habitId);
...
//     // Update the habit selection status using MyButtonClickedProvider
//     final buttonProvider =
//         Provider.of<MyButtonClickedProvider>(context, listen: false);
//     if (isSelected) {
//       buttonProvider.setSelectedDayIndex(widget.habitId, index);
//     } else {
//       buttonProvider.setSelectedDayIndex(widget.habitId, -1);
//     }
//   }
